package megaminds.demo.splashscreen;
...
import megaminds.demo.R;
import megaminds.demo.SearchBarMediaActivity;
import megaminds.demo.font.FontelloTextView;
	...
	private void animation3() {
		...
		private class BackgroundSplashTask extends AsyncTask<Void, Void, Void> {
			...
			protected void onPostExecute(Void result) {
               ...
               // gpsOnOff();
				if(rememberMe==true){
					Intent intent = new Intent(SplashScreenLauncherActivity.this, SearchBarMediaActivity.class);
					startActivity(intent);
				}
				else {
					Intent i = new Intent(SplashScreenLauncherActivity.this, SearchBarMediaActivity.class);
